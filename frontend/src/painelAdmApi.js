...
export const painelAdmApi = {
  ...
  centralVisaoGeral: () => chamar("/comunicacao/central/visao-geral"),
  centralAutomacoes: () => chamar("/comunicacao/central/automacoes"),
  centralDestinatarios: ({ busca } = {}) => chamar("/comunicacao/central/destinatarios" + qs({ busca })),
  centralHistorico: (filtros = {}) => chamar("/comunicacao/central/historico" + qs(filtros)),
  centralDiagnostico: () => chamar("/comunicacao/central/diagnostico"),
