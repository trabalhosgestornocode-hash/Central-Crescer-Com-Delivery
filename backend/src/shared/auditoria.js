...
export const ACOES = {
  ...
  COMUNICACAO_CONVERSA_ABERTA: "COMUNICACAO_CONVERSA_ABERTA",

  // Aba Conexão (identidade do WhatsApp) — sempre com ator humano. NUNCA registram QR, auth state, chaves, tokens nem telefone completo (só mascarado).
  WHATSAPP_CONEXAO_INICIADA: "WHATSAPP_CONEXAO_INICIADA",
  WHATSAPP_QR_GERADO: "WHATSAPP_QR_GERADO",
  WHATSAPP_CONECTADO: "WHATSAPP_CONECTADO",
  WHATSAPP_DESCONECTADO: "WHATSAPP_DESCONECTADO",
  WHATSAPP_CONEXAO_FALHOU: "WHATSAPP_CONEXAO_FALHOU",
  WHATSAPP_IDENTIDADE_DEFINIDA: "WHATSAPP_IDENTIDADE_DEFINIDA",
  WHATSAPP_CONEXAO_RECONCILIADA: "WHATSAPP_CONEXAO_RECONCILIADA",
};
