...
test('mês e simulador: proteção da precificação separada das metas logísticas',async()=>{
 ...
 // LIMITES continuam logísticos (metas_indicadores); META IDEAL de Serviços
 // acompanha a proteção; o Total é a SOMA das metas dos componentes aplicáveis
 // (Marketplace: Taxas 13 + Serviços + Entregadores 12).
 ...
 assert.equal(a.indicadoresRentabilidade.total_deducoes.metaIdeal.toFixed(2),'31.43'); // 13 + 6,43 + 12 (sem clamp, coincide c/ protecao)
